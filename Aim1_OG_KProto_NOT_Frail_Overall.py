...
df_train = pd.read_csv('/file_path/file_name.csv')
df_testing = pd.read_csv('/file_path/file_name.csv')
...
# Any blank not yet delt with will be filled with NA (this primarily applies to the numerical column -- age)
df = df.fillna(-5)
